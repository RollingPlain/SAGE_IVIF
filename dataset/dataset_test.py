...
# import utils
# class Data(Dataset):
#     def __init__(self, mode, mask_num=20, crop_size=(600, 800), img_dir='/mnt/disk1/IVIF/M3FD_4200'):
...
#         # 使用对应的扩展名构建完整文件路径
#         ir_ext = self.ir_extensions.get(name_0, '.jpg')  # 默认使用.png作为后备
#         vis_ext = self.vis_extensions.get(name_0, '.jpg')
...
#         vi_0 = self.trans(self.totensor(cv2.cvtColor(vi_0, cv2.COLOR_BGR2YCrCb)), seed)  # CHW
...
#         result = {'name':name_0, 'label':label, 'ir':ir_0, 'y':y_0, 'cb':cb, 'cr':cr}
